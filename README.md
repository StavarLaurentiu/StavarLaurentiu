...
<b><p align="center"> A determined, hard-working and detail-oriented first year Computer Science and Engineering Master's Student with good associate programming hard-skills in Assembly x86, C, C++, Rust, C#, Java, Python, HTML, CSS, JavaScript, TypeScript, Angular, React and NodeJS. Outstanding network knowledge such as routing, switching and security technologies and advanced UNIX/Linux operating system knowledge, excellent team player, strong problem-solving abilities and excellent communication skills in English.</p></b>
