...
<b><p align="center"> A determined, hard-working and detail-oriented final year Computer Science and Engineering Student with good associate programming hard-skills in Assembly x86, C, C++, Rust, C#, Java, Python, NumPy, Pandas, Scikit-learn, FastAPI, HTML, CSS, JavaScript, TypeScript, Angular, React, NodeJS, Racket, Haskell, Prolog and Unity. Outstanding network knowledge such as routing, switching and security technologies and advanced UNIX/Linux operating system knowledge, excellent team player, strong problem-solving abilities and excellent communication skills in English.</p></b>
...
<br/>
<div align="center">
    <img src="https://skillicons.dev/icons?i=vscode,github,git,azure,docker,c,cpp,csharp,rust,java,python,html,css,javascript,typescript,angular,react,matlab,haskell" />
</div>
